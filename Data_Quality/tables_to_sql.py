...
if b_get_table_count:
    ...
    for col_name in [u'Landing Tables']:
        for this_name in DQ_Tables[col_name]:
            ...
            f_out.write("union select '" + str(this_name) + "' as table_name, count(*) as table_count from (select * FROM CTRMSO." + str(this_name) + ') nest \n')
